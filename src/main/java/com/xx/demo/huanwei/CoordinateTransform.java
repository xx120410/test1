...
public class CoordinateTransform {
    ...
    public static void main(String[] args) {
        ...
        double[] lngLat_wgs84 = CoordinateTransform.transformBD09ToWGS84(104.73779072, 31.4481098953);
        System.out.println("lng :" + lngLat_wgs84[0] + ",lat :" + lngLat_wgs84[1]);
        double lonF = (lngLat_wgs84[0] % 1)*60;
        int lonD = (int) (lngLat_wgs84[0] / 1);
        double lng = lonD*100 + lonF;
        System.out.println("lng = " + lng);

        double latF = (lngLat_wgs84[1] % 1)*60;
        int latD = (int) (lngLat_wgs84[1] / 1);
        double lat = latD*100 + latF;
        System.out.println("lat = " + lat);

//        //WGS84  坐标 转 百度地图 BD09
        double[] lngLat_bd09 = CoordinateTransform.transformWGS84ToBD09(104.72853873172392, 31.44429444729618);
        System.out.println("lng :" + lngLat_bd09[0] + ",lat :" + lngLat_bd09[1]);
//
//        //火星坐标（GCJ02） 坐标 转 WGS84
//        lngLat_wgs84 = CoordinateTransform.transformGCJ02ToWGS84(104.75000675155147, 31.443113094325902);
//        System.out.println("lng :" + lngLat_wgs84[0] + ",lat :" + lngLat_wgs84[1]);
//
//        //WGS84 转  火星坐标（GCJ02）
//        double[] lngLat_gcj02 = CoordinateTransform.transformWGS84ToGCJ02(104.75000675155147, 31.443113094325902);
//        System.out.println("lng :" + lngLat_gcj02[0] + ",lat :" + lngLat_gcj02[1]);
//
//        //百度地图 BD09 坐标 转 火星坐标（GCJ02）
//        lngLat_gcj02 = CoordinateTransform.transformBD09ToGCJ02(104.75000675155147, 31.443113094325902);
//        System.out.println("lng :" + lngLat_gcj02[0] + ",lat :" + lngLat_gcj02[1]);
//
//        //火星坐标（GCJ02） 坐标 转 百度地图 BD09
//        lngLat_bd09 = CoordinateTransform.transformGCJ02ToBD09(104.75000675155147, 31.443113094325902);
//        System.out.println("lng :" + lngLat_bd09[0] + ",lat :" + lngLat_bd09[1]);
    }
}
